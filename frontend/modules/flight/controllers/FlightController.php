...
namespace frontend\modules\flight\controllers;

use Yii;
use common\models\Flight;
use frontend\modules\flight\models\FlightSearch;
...
class FlightController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $model->flight_datetime = strtotime(Yii::$app->request->post()['Flight']['flight_datetime']);
            $model->status = 0;
            $model->amount_of_places = 150;
            $model->save();
